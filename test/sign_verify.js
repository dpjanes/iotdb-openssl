...
describe("sign_verify", function() {
    it("dgst works", function(done) {
        _.promise({
            document_in: "Hello World",
            document_out: null,
            dgst_in: {
                sha256: true,
